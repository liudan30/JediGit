...
function buildContent(key){
  ...
  library1.appendChild(document.createTextNode(dict.find(key)[0]));
  ...
  library2.appendChild(document.createTextNode(dict.find(key)[2]));
  ...
  library3.appendChild(document.createTextNode(dict.find(key)[4]));
