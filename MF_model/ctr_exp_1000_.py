...
if __name__ == "__main__":
	...
	model = ctr_.CTR(user_num, item_num, user_item_dict, voc_num, doc_ids, doc_cnt, repo_id_name_dict, package_id_name_dict, "recommendation_result_ctr_1000.txt", lambda_u = 1000)
	model.fit()
