...
if __name__ == "__main__":
	...
	model = ctr.CTR(user_num, item_num, user_item_dict, voc_num, doc_ids, doc_cnt, lambda_u = 1000)
	model.fit()
	...
	common_function.write_recommendation_result("recommendation_result_ctr_1000.txt", top_20_item, repo_id_name_dict, package_id_name_dict)
