...
if __name__ == "__main__":
	...
	for i in range(0, 20):
		...
		recall_ctr_10[i] = float(recall_ctr_10[i]) / float(total_number)
		recall_ctr_100[i] = float(recall_ctr_100[i]) / float(total_number)
		recall_ctr_1000 [i] = float(recall_ctr_1000[i]) / float(total_number)
